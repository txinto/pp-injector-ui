 ...
 *
 */
#define LVGL_PORT_H_RES             (CONFIG_TOUCHSCREEN_LCD_H_RES)
#define LVGL_PORT_V_RES             (CONFIG_TOUCHSCREEN_LCD_V_RES)
...
#else
#define LVGL_PORT_BUFFER_HEIGHT         (80)
#endif

#ifndef LVGL_PORT_BUFFER_MALLOC_CAPS
